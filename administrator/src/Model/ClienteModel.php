...
class ClienteModel extends AdminModel
{
	 ...
	 * @since  1.0.0
	 */
	protected $text_prefix = 'COM_ICODE_CLIENTES';
	 ...
	 * @since  1.0.0
	 */
	public $typeAlias = 'com_icode_clientes.cliente';
	...
	*/
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_icode_clientes.edit.cliente.data', array());
	...
	public function duplicate(&$pks)
	{
		...
		// Access checks.
		if (!$user->authorise('core.create', 'com_icode_clientes'))
		{
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = $this->getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__icode_clientes');
				$max             = $db->loadResult();
